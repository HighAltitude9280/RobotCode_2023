...
public class RobotMap {
    ...
    //Left side
    public static final int[] DRIVETRAIN_LEFT_MOTOR_PORTS = {0,1};
    public static final int[] DRIVETRAIN_LEFT_INVERTED_MOTORS_PORTS = {0,1};
    ...
    //Right side
    public static final int[] DRIVETRAIN_RIGHT_MOTOR_PORTS = {2,3};
    ...
    //Dragonfly 
    public static final boolean DRIVETRAIN_DRAGONFLY_IS_AVAILABLE = true;
