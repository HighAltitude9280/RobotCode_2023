...
public class RobotMap {
    ...
    public static final TypeOfMotor[] DRIVETRAIN_LEFT_MOTOR_TYPES = { TypeOfMotor.VICTOR_SPX, TypeOfMotor.VICTOR_SPX };
    ...
    public static final TypeOfMotor[] DRIVETRAIN_RIGHT_MOTOR_TYPES = { TypeOfMotor.VICTOR_SPX, TypeOfMotor.VICTOR_SPX };
