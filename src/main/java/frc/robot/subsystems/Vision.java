...
public class Vision extends SubsystemBase {
  ...
  public double getDist() {
    if (resultsssss != null && resultsssss.length >= 1) {
      double x1 = resultsssss[0].getCornerX(0);
      double y1 = resultsssss[0].getCornerY(0);
      double x2 = resultsssss[0].getCornerX(3);
      double y2 = resultsssss[0].getCornerY(3);

      double xd = Math.distance(x1, x2, y1, y2);
      return xd;
    } else
      return 0;
  }
