...
public class SwerveDriveTrain extends SubsystemBase {
  ...
  public void periodic() {
    updateOdometry();
    Robot.debugNumberSmartDashboard("OdoX", swerveDrivePoseEstimator.getEstimatedPosition().getX());
    Robot.debugNumberSmartDashboard("OdoY", swerveDrivePoseEstimator.getEstimatedPosition().getY());
