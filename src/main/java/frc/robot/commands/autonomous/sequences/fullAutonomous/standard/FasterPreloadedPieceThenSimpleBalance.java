...
public class FasterPreloadedPieceThenSimpleBalance extends SequentialCommandGroup {
  /** Creates a new FasterPreloadedPieceThenSimpleBalce. */
  public FasterPreloadedPieceThenSimpleBalance(GamePieceMode g) {
    ...
    addCommands(
        ...
        Commands.parallel(
            Commands.sequence(
                ...
                new MoveStraight(10, 0.3).withTimeout(0.125),
                new AutoBalanceSimpleFwd().withTimeout(5)),
