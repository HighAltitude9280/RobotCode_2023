...
public class FasterPreloadedPieceThenMoveStraight extends SequentialCommandGroup {
  GamePieceMode gamePieceMode;

  /** Creates a new FasterPreloadedPiece. */
  public FasterPreloadedPieceThenMoveStraight(GamePieceMode g) {
    gamePieceMode = g;
    addCommands(
        ...
        Commands.parallel(
            ...
            new TransportGoTo(TransportTarget.RESTING)));
  }
}
