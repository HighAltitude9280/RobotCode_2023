...
public class Paths 
{
    ...
    public static final CubicSpline piece4ToPositionHBlue = 
        SplineGenerator.generateHermiteClampedSpline(piece4ToPositionHBlueControlPoints, 
    ...
    public static final CubicSpline piece4ToPositionHRed = 
        SplineGenerator.generateHermiteClampedSpline(piece4ToPositionHRedControlPoints, 
    ...
    public static final CubicSpline positionHToChargingBlue = 
        SplineGenerator.generateHermiteClampedSpline(positionHToChargingBlueControlPoints, 
    ...
    public static final CubicSpline positionHToChargingRed = 
        SplineGenerator.generateHermiteClampedSpline(positionHToChargingRedControlPoints, 
