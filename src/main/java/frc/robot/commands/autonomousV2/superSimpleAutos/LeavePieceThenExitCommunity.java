...
public class LeavePieceThenExitCommunity extends SequentialCommandGroup {
  /** Creates a new LeavePieceThenGoForward. */
  public LeavePieceThenExitCommunity(GamePieceMode gamePieceMode, TransportTarget target) {
    ...
    addCommands(
        ...
        Commands.parallel(
            ...
            new SwerveDriveDistanceFwd(1.0, 4.2, 1.0, true)));
  }// 4.2m
