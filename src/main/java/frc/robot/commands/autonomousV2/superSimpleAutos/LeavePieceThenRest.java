...
public class LeavePieceThenRest extends SequentialCommandGroup {
  /** Creates a new LeavePieceThenRest. */
  public LeavePieceThenRest(GamePieceMode gamePieceMode, TransportTarget target) {
