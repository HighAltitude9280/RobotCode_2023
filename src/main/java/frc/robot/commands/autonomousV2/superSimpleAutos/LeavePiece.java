...
public class LeavePiece extends SequentialCommandGroup {
  /** Creates a new LeavePiece. */
  public LeavePiece(GamePieceMode gamePieceMode, TransportTarget target) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(new SetGamePieceMode(gamePieceMode),
