...
public class SwerveWaitForFall extends CommandBase {
  ...
  double vx;
  double kAngularVelocityThreshold = HighAltitudeConstants.BALANCING_SPEED_THRESHOLD;
  ...
  public SwerveWaitForFall(double vx, double kAngularVelocityThreshold) {
    this.vx = vx;
    this.kAngularVelocityThreshold = kAngularVelocityThreshold;
    swerveDriveTrain = Robot.getRobotContainer().getSwerveDriveTrain();
    addRequirements(swerveDriveTrain);
    // Use addRequirements() here to declare subsystem dependencies.
  }
