...
public class GoToBottomRow extends SequentialCommandGroup {
  ...
  public GoToBottomRow() {
    ...
    switch (currentGamePieceMode) {
      case CONE:
        wristTarget = HighAltitudeConstants.WRIST_BOTTOM_ROW_DEGREES_CONE;
        armTarget = HighAltitudeConstants.ARM_BOTTOM_ROW_DEGREES_CONE;
        extensorTarget = HighAltitudeConstants.EXTENSOR_BOTTOM_ROW_METERS_CONE;
        break;
      case CUBE:
        wristTarget = HighAltitudeConstants.WRIST_BOTTOM_ROW_DEGREES_CUBE;
        armTarget = HighAltitudeConstants.ARM_BOTTOM_ROW_DEGREES_CUBE;
        extensorTarget = HighAltitudeConstants.EXTENSOR_BOTTOM_ROW_METERS_CUBE;
        break;
      case MANUAL:
        return;
      default:
