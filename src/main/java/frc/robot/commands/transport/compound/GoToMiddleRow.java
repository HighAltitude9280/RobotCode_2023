...
public class GoToMiddleRow extends SequentialCommandGroup {
  ...
  public GoToMiddleRow() {
    ...
    switch (currentGamePieceMode) {
      case CONE:
        wristTarget = HighAltitudeConstants.WRIST_MIDDLE_ROW_DEGREES_CONE;
        armTarget = HighAltitudeConstants.ARM_MIDDLE_ROW_DEGREES_CONE;
        extensorTarget = HighAltitudeConstants.EXTENSOR_MIDDLE_ROW_METERS_CONE;
        break;
      case CUBE:
        wristTarget = HighAltitudeConstants.WRIST_MIDDLE_ROW_DEGREES_CUBE;
